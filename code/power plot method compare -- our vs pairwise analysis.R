...
mydata.balance.100 <- readRDS("pairwise.comparison.balance.100.rds")
mydata.ubbalance.100 <- readRDS("pairwise.comparison.unbalance.100.rds")
mydata.nominal.100 <- readRDS("pairwise.comparison.nominal.100.rds")
mydata.balance.200 <- readRDS("pairwise.comparison.balance.200.rds")
mydata.ubbalance.200 <- readRDS("pairwise.comparison.unbalance.200.rds")
mydata.nominal.200 <- readRDS("pairwise.comparison.nominal.200.rds")
...
setEPS()
postscript("multiMiAT.pairwise.comparison.100.eps", width = 10, height = 12)
showtext_begin()
...
lines(x, mydata1.balance.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 70, legend = colnames(mydata1.balance.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata1.unbalance.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 70, legend = colnames(mydata1.unbalance.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata1.nominal.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 90, legend = colnames(mydata1.nominal.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.balance.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata2.balance.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.unbalance.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata2.unbalance.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.nominal.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 50, legend = colnames(mydata2.nominal.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.balance.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata3.balance.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.unbalance.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 90, legend = colnames(mydata3.unbalance.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.nominal.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 45, legend = colnames(mydata3.nominal.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.balance.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 70, legend = colnames(mydata4.balance.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.unbalance.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 70, legend = colnames(mydata4.unbalance.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.nominal.100[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.100[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.100[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.100[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.100[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 70, legend = colnames(mydata4.nominal.100), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
setEPS()
postscript("multiMiAT.pairwise.comparison.200.eps", width = 10, height = 12)
showtext_begin()
...
lines(x, mydata1.balance.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 85, legend = colnames(mydata1.balance.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata1.unbalance.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 50, legend = colnames(mydata1.unbalance.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata1.nominal.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 35, legend = colnames(mydata1.nominal.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.balance.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata2.balance.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.unbalance.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata2.unbalance.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.nominal.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata2.nominal.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.balance.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata3.balance.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.unbalance.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata3.unbalance.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.nominal.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(0.8, 100, legend = colnames(mydata3.nominal.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.balance.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 85, legend = colnames(mydata4.balance.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
axis(1, c(1, 3, 5, 7, 9), c(0, 0.5, 1, 1.5, 2))
lines(x, mydata4.unbalance.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 70, legend = colnames(mydata4.unbalance.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.nominal.200[, "aMiSPU"], type = "b", col = "yellow", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.200[, "MiHC"], type = "b", col = "pink", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.200[, "OMiAT"], type = "b", col = "green", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.200[, "OMiRKAT"], type = "b", col = "orange", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.200[, "multiMiAT"], type = "b", col = "red", pch = 20, lty = 1, lwd = 1, cex = 1.5)
legend(7, 35, legend = colnames(mydata4.nominal.200), col = c("yellow", "pink", "green", "orange", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
