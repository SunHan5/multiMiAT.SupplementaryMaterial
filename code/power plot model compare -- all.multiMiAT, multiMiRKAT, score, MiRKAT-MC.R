...
mydata1.balance.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario1.balance.100.rds")
mydata2.balance.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario2.balance.100.rds")
mydata3.balance.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario3.balance.100.rds")
mydata4.balance.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario4.balance.100.rds")

mydata1.unbalance.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario1.unbalance.100.rds")
mydata2.unbalance.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario2.unbalance.100.rds")
mydata3.unbalance.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario3.unbalance.100.rds")
mydata4.unbalance.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario4.unbalance.100.rds")

mydata1.nominal.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario1.nominal.100.rds")
mydata2.nominal.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario2.nominal.100.rds")
mydata3.nominal.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario3.nominal.100.rds")
mydata4.nominal.100 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario4.nominal.100.rds")

mydata1.balance.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario1.balance.200.rds")
mydata2.balance.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario2.balance.200.rds")
mydata3.balance.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario3.balance.200.rds")
mydata4.balance.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario4.balance.200.rds")

mydata1.unbalance.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario1.unbalance.200.rds")
mydata2.unbalance.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario2.unbalance.200.rds")
mydata3.unbalance.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario3.unbalance.200.rds")
mydata4.unbalance.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario4.unbalance.200.rds")

mydata1.nominal.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario1.nominal.200.rds")
mydata2.nominal.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario2.nominal.200.rds")
mydata3.nominal.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario3.nominal.200.rds")
mydata4.nominal.200 <- readRDS("all.multiMiRKAT.multiMiAT.comparison.scenario4.nominal.200.rds")
...
setEPS()
postscript("E:/sun/multiMiRKAT/plot/figs/all.multiMiRKAT.multiMiAT.comparison.100.eps", width = 10, height = 12)
showtext_begin()
...
lines(x, mydata1.balance.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 62.8, legend = colnames(mydata1.balance.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata1.unbalance.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 55.6, legend = colnames(mydata1.unbalance.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata1.nominal.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 88, legend = colnames(mydata1.nominal.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.balance.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 100, legend = colnames(mydata2.balance.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.unbalance.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 100, legend = colnames(mydata2.unbalance.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.nominal.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 55, legend = colnames(mydata2.nominal.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.balance.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 100, legend = colnames(mydata3.balance.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.unbalance.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 90, legend = colnames(mydata3.unbalance.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.nominal.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 25, legend = colnames(mydata3.nominal.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.balance.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 61.1, legend = colnames(mydata4.balance.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.unbalance.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 51.7, legend = colnames(mydata4.unbalance.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.nominal.100[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.100[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.100[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 47.2, legend = colnames(mydata4.nominal.100), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
setEPS()
postscript("E:/sun/multiMiRKAT/plot/figs/all.multiMiRKAT.multiMiAT.comparison.200.eps", width = 10, height = 12)
showtext_begin()
...
lines(x, mydata1.balance.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.balance.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 83.3, legend = colnames(mydata1.balance.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata1.unbalance.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.unbalance.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 75, legend = colnames(mydata1.unbalance.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata1.nominal.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata1.nominal.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 47.2, legend = colnames(mydata1.nominal.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.balance.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.balance.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 50, legend = colnames(mydata2.balance.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.unbalance.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.unbalance.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 50, legend = colnames(mydata2.unbalance.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata2.nominal.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata2.nominal.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 100, legend = colnames(mydata2.nominal.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.balance.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.balance.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 47.2, legend = colnames(mydata3.balance.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.unbalance.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.unbalance.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 47.2, legend = colnames(mydata3.unbalance.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata3.nominal.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata3.nominal.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(0.5, 50, legend = colnames(mydata3.nominal.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.balance.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.balance.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 91.1, legend = colnames(mydata4.balance.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.unbalance.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.unbalance.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 72.2, legend = colnames(mydata4.unbalance.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
...
lines(x, mydata4.nominal.200[, "MiRKAT-MC+score"], type = "b", col = "tan", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.200[, "multiMiRKAT+score"], type = "b", col = "thistle", pch = 20, lty = 1, lwd = 1, cex = 1.5)
lines(x, mydata4.nominal.200[, "multiMiRKAT+MiRKAT-MC"], type = "b", col = "khaki", pch = 20, lty = 1, lwd = 1, cex = 1.5)
...
legend(5.5, 47.2, legend = colnames(mydata4.nominal.200), col = c("black", "skyblue", "slateblue", "orange", "green", "tan", "thistle", "khaki", "blue", "red"), cex = 0.6, lty = 1, lwd = 2, pch = 20, bty="n")
